...
const CrearProfesional = ( { ejecutarCard }) => {
  return (
    <div
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            <h3 className="font-bold text-gray-800 text-xl mb-2">Asociar profesional</h3>
            <p className="text-gray-600 text-sm mb-4">Asociar profesional al consultorio</p>
          </div>
