...
const SearchModal = ({
  ...
  {/* Contenedor del modal: forma visual con bordes redondeados */}
  <div className="bg-white backdrop-blur-sm xl:rounded-3xl shadow-xl border border-gray-200/50 w-screen xl:max-w-6xl h-screen xl:h-auto xl:max-h-[90vh] flex flex-col relative overflow-hidden">
    
    {/* Botón de cierre (fuera del scroll, siempre visible) */}
    <button
      onClick={cerrarModal}
    ...
    {/* Contenedor interno con scroll (la barra ahora está DENTRO del borde redondeado) */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 place-items-center">
                {filteredDoctors.map((doctor, index) => (
                  <div
                    ...
                    className="relative bg-white/90 backdrop-blur-md rounded-3xl shadow-xl border border-gray-100 hover:border-indigo-400 hover:shadow-2xl transform transition-all duration-500 hover:scale-[1.02] flex flex-col h-full group overflow-hidden w-80"
                  >
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      <div className="p-6 pb-4 border-b border-gray-100/70">
                        <div className="flex items-start gap-5">
                          <div className="bg-gradient-to-br from-indigo-500 to-purple-600 p-4 rounded-xl text-white flex-shrink-0 shadow-lg group-hover:from-indigo-600 group-hover:to-purple-700 transition-all duration-300 transform group-hover:scale-105">
                            <FaUserDoctor className="text-3xl" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <h3 className="text-xl font-extrabold text-gray-900 group-hover:text-indigo-800 transition-colors duration-300 truncate mb-1">
                      ...
                      <div className="p-5 bg-gray-50/80 rounded-b-3xl border-t border-gray-100/70 mt-auto">
