...
>
  ...
  >
    <h1
      id="hero-title"
      className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-5 text-center"
    >
      Turnos médicos{" "}
    ...
    <motion.button
      ...
      className="group mx-auto inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-500 to-teal-500 text-white font-semibold text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 focus:ring-4 focus:ring-cyan-300 text-center"
      whileHover={{ y: -2 }}
      whileTap={{ scale: 0.97 }}
    >
